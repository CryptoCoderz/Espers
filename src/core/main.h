...
inline bool FACTOR_TOGGLE(int nHeight) { return TestNet() || nHeight > 985000; }
...
/** (try to) add transaction to acceptable inputs **/
bool AcceptableInputs(CTxMemPool& pool, CTransaction &tx, bool fLimitFree, bool* pfMissingInputs);
...
public:
     ...
     */
    bool FetchInputs(CTxDB& txdb, const std::map<uint256, CTxIndex>& mapTxPool,
